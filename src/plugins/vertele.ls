...
# const API_ROOT = "http://affinaty.com:1155/api"
const API_ROOT = "http://localhost:1155/api"
...
function stats-module (el, id, _config, _data)
  ...
  el.appendChild \
    s \svg width: svg_width, height: svg_height, !->
      ...
      panels = new Array 4
      panel_title = value ''
      set_panel = value 'percent' # 'province' # 'percent'
      buttons = []
      svg_els = [
        s \style, """
        g.button {
      ...
      svg_els.push panels.3 = s \g.province-stats, transform: "translate(0 #{bottom_panel_y})", ->
        ...
        set_province_stats (data) !->
          ...
          # for code, v of stats
          #   p = province-els[code]
          #   p.set-attribute \fill, "rgb(#{Math.round (v / max) * 255},0,0)"
          for s, i in stats_rank
            for _p in s.p
              p = province-els[_p]
...
# http://affinaty.com:1155/api/poll*?creator=55c381409123415c00a3b046
